  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-violet-500/40 border-t-violet-400/60 bg-gradient-to-b from-[#121426]/90 via-[#0d0f1c]/85 to-[#090a12]/90 backdrop-blur-xl p-8 sm:p-14 text-center shadow-[0_20px_60px_rgba(124,58,237,0.25),inset_0_1px_0_rgba(255,255,255,0.15)] space-y-8 relative overflow-hidden">
          {/* Subtle Grid overlay */}
